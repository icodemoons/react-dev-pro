...
function DesktopMenu({ children }) {
  return (
    <div className="hidden w-full justify-between bg-white p-5 px-6 pt-10 text-2xl font-medium text-black md:block">
...
function MobileMenu({ children }) {
  ...
  return (
    <div
      className="z-50 w-full bg-white md:hidden
    "
    >
      ...
      {open && (
        <div
          ...
          className="fixed  top-0 left-0 right-0 border  bg-white"
        >
