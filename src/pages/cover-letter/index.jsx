  ...
  return (
    <>
      <Container>
        ...
        <div className=" mt-10 mb-10  p-10  bg-indigo-100 duration-1000">

          <em className="bg-yellow-500 text-black text-2xl text-center"> cover letter:</em> 
          <br /> <br />
  
          <p className=" text-left lg:text-xl md:text-2xl text-lg p-5 text-black">

            I specialize in helping brands,small businesses, and people alike with their e-commerce stores by taking their vision and turning it into a thriving reality. I have worked with a variety of clients, such as lawyers, interior designers, accountants, health companies, celebrities, hotels, start ups and airports. During this time, it was some of the most challenging but rewarding work I have ever done. I enjoy the challenge of working with various types of people and companies as I find it to be rewarding.
            <br /><br />
            ...
            I know that I will bring my versitallity, passion, kindness and creativity and the best of me to the role I am applying for or another that you might feel is a better fit.
