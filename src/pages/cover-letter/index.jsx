...
export default function CoverLetter() {
  return (
    <>
      <Container>
        <div className=" mt-10 mb-10  bg-indigo-100  p-10 duration-1000">
          <em className="bg-yellow-500 text-center text-2xl text-black">
            {" "}
            cover letter:
          </em>
          <br /> <br />
          <p className=" p-5 text-left text-lg text-black md:text-2xl lg:text-xl">
          I specialize in helping brands, small businesses, and people alike
          ...
          <span className="mr-2 bg-yellow-400 text-black">
            Thank you, I look forward to working with you all. Best!
          </span>
          </p>
        </div>
      </Container>
