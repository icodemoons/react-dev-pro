...
export default function Experience() {
  return (
    <>
      <div className="absolute -z-50 mt-16 mb-8 overflow-hidden shadow-xl shadow-gray-200  sm:rounded-lg md:mx-10 lg:mx-20">
        <div className=" rounded-lg bg-indigo-600 px-4 py-5 text-white  sm:px-6">
          ...
          <p className="max-w-2xl text-base text-yellow-400">Past to Present</p>
        </div>
          ...
          <dl>
            ...
            <div className="bg-slate-100 px-4 py-5 leading-relaxed sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="leading-1 mt-1 text-base leading-normal   tracking-tight text-black sm:col-span-2 sm:mt-0">
                ...
                <p className="mt-1">
                  ...
                  in marketing and advertising and worked on bugs in the source
                  code.
                </p>
                <p className="mt-1">
                ...
                <p className="mt-1">
                  {" "}
                  Listened attentively to clients’ needs and worked with them on
                  a personal level to find products that match their lifestyle.
                  I also delivered and assembled products when needed.
                </p>
              </dd>
            </div>
            ...
            <div className="bg-slate-100 px-4 py-5 leading-relaxed sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="leading-1 mt-1 text-base leading-normal   tracking-tight text-black sm:col-span-2 sm:mt-0">
                ...
                <p className="mt-1">
                  Optimized and helped rebuild the website for a better shopping
                  experience by recreating the checkout process and created a
                  dropdown menu with inline Javascript.
                </p>
                <p className="mt-1">
            ...
            <div className="bg-slate-100  px-4 py-5 leading-relaxed sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="leading-1 mt-1 text-base leading-normal   tracking-tight text-black sm:col-span-2 sm:mt-0">
                <div>
                  <p className="mt-1">
                    <strong>
                      Web Development Specialist, Brand facilitator and Account
                      Manager.
                    </strong>
                    <span className="float-right  font-medium">2014-2020</span>
                  </p>
                </div>
                <span className=" mt-1 text-black blur-sm hover:blur-none ">
                  {" "}
                ...
                <p className="mt-1">
                  Strategized the brand’s online identity from website creation
                  to content, marketing and promotional materials.
                </p>
                <p className="mt-1">
                  Ran trade show booths, presented and sold products at events,
                  networked, Dj'd, and danced to entertain our crowds.
                </p>
              </dd>
            </div>
          </dl>
